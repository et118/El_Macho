...
public class SkipCommand extends Command {
    public SkipCommand(CommandInfo commandInfo) {
        super(commandInfo);
    }
    ...
    public Mono<Void> execute(MessageCreateEvent event) {
        ...
        Mono<Void> skipTrack = Mono.fromRunnable(()-> MusicManager.getTrackScheduler(event.getGuildId().get()).skip());
        ...
        return skipTrack.then(sendFeedback);
    }
}
